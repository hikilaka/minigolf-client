...
public class GameApplet extends AApplet {
    ...
    public void defineImages(ImageManager imageManager, String var2) {
        ...
        imageManager.defineImage("login-banner.jpg");
    ...
    public void appletReady() {
        ...
        this.setGameSettings(false, 0, false, true);
    ...
    protected void trackTestLogin(String username, String password) {
        ...
        if (username.trim().length() == 0 || password.trim().length() == 0) {
        	gameContainer.connection.writeData("loginanon");
        } else {
        	gameContainer.connection.writeData("login\t" + username + "\t" + password);
        }
    }
