...
public final class SoundManager implements Runnable {
    ...
    public void defineSound(String var1, String var2) {
        ...
        SoundClip var3 = new SoundClip(this.anApplet1485, this.anURL1486, var2, this.aBoolean1488);
    ...
    private void method1691(int var1) {
        SoundClip var2 = (SoundClip) ((SoundClip) this.aHashtable1489.get(new Integer(var1)));
        if (var2 != null) {
            AudioClip var3 = var2.getClip();
            if (var3 != null) {
                var3.play();
            }
        }
    ...
    private void method1692(String var1, int var2) {
        try {
            ...
            SoundClip var3 = (SoundClip) ((SoundClip) this.aHashtable1490.get(var1));
            if (var3 != null) {
                AudioClip var4 = var3.getClip();
                if (var4 != null) {
                    if (var2 == 0) {
                        var4.stop();
                    } else if (var2 == 1) {
