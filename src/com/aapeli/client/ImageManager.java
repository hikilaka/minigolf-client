...
public final class ImageManager {
    ...
    public ImageManager(Applet applet, String imageDir, boolean isDebug) {
        ...
        try {
            this.codebaseURL = applet.getCodeBase(); //new File(host).toURI().toURL();
        } catch (Exception e) {
            e.printStackTrace();
        }
...
public String defineImage(String imageAlias, String imageFileName) {
    ...
    try {
    	Path path = Paths.get("res", "AGolf", "picture", method1597(imageFileName));
    	Image var3 = ImageIO.read(path.toFile());
        imageTracker.registerImage(imageAlias, var3);
    } catch (Exception e) {
    	e.printStackTrace();
    }
    return imageAlias;
...
public String defineSharedImage(String imageAlias, String imageFileName) {
    ...
    try {
    	Path path = Paths.get("res", "Shared", "picture", method1597(imageFileName));
    	Image var3 = ImageIO.read(path.toFile());
        imageTracker.registerImage(imageAlias, var3);
    } catch (Exception e) {
    	e.printStackTrace();
    ...
    public int getWidth(Image var1) {
    	if (var1 == null) System.out.println("var1 null!");
    	if (applet == null) System.out.println("applet null!");
